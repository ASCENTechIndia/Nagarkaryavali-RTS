            ...
            <main className="flex min-h-[calc(100vh-72px)] flex-col items-center px-4 py-6 sm:py-8">
                ...
                >
                    <div className="relative hidden shrink-0 overflow-hidden bg-[#bad2fa] lg:block lg:w-[40%]">
                        ...
                        <div className="absolute left-32 top-1/2 -translate-y-1/2 w-32.5 h-32.5 rounded-full  bg-[#184aa6] border-10 border-white flex items-center justify-center z-20">
                            <img src="/login-label.png" alt="Login" className="w-16 h-16 object-contain shadow" />
                        </div>
                    </div>
                    <div className="z-10 w-full p-5 lg:px-1.5 lg:py-5 lg:w-[60%]">
                        <Formik initialValues={{ ulb: "", in_UserId: "", in_password: "", captcha: "" }} onSubmit={handleLogin}>
                                ...
                                <Form className="space-y-4">
                                    ...
                                    >
                                        <div className="flex items-center gap-1">
                                            ...
                                            <Select
                                                value={values.ulb}
                                                onValueChange={(value) => setFieldValue("ulb", value)}
                                            >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="ulb3">ULB 3</SelectItem>
                                                    <SelectItem value="ulb4">ULB 4</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    </motion.div>
                                    ...
                                    {error && (
                                        <motion.div
                                            ...
                                            className="underline text-center text-sm font-medium text-red-600"
                                        >
                                            {error}
                                        </motion.div>
                                    )}
