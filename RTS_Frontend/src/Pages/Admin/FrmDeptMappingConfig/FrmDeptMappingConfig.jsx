...
const getUserDepartmentConfig = async (
selectedUserId,
setFieldValue,
) => {
if (!selectedUserId) {
...
const ipAddress = await getIPAddress();
  ...
  console.log(
    "Save User Department Configuration Payload:",
    payload,
  );
  ...
  console.error(
    "Submit Department Configuration Error:",
    error,
  );
...
isSubmitting,
    ...
    const tableData = departments.map(
      (item) => ({
        ...item,
        checked:
          values.selectedDepartments.includes(
            Number(item.DEPTID),
          ),
      }),
    );
