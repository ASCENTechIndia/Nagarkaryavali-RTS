  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/api/FrmSecondAppealAutoRpt/second-appeal-report-pdf  `,
        requestData,
        {
          headers: {
            ...
            <Card className="border shadow-sm">
              <CardHeader className="border-b">
                <CardTitle className="text-lg font-semibold">
                  Second Appeal Authority Report
                </CardTitle>
              </CardHeader>
...
export default FrmSecondAppealAutoRpt;
