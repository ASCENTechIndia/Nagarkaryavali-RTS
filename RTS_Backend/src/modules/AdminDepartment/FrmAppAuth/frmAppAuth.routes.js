...
router.post( "/application-verification-document", auth(), upload.array("documents", 10), controller.saveApplicationVerificationDocument);router.post("/menu-details", auth(), controller.getMenuDetails);
